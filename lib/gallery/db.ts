...
function seedIfEmpty() {
  ...
  const seedArtworks: Array<Partial<ArtworkInput> & { title: string; year: number; imageSeed: string }> = [
    {
      ...
      story: 'He watched her eat first.\n\nHe had heard the warning himself, face to face, before she ever existed — there was no confusion about the cost.\n\nHe ate anyway. Not out of deception. Out of not wanting her to be alone in it.\n\nThis is the second before everything changed, for both of them, and for everyone after — Genesis 3:6, from the one angle it almost never gets drawn from.',
      categories: ['religious', 'human_emotion'],
    ...
    },
    {
      ...
      story: 'Before anything is public, it is decided somewhere private — on your knees, alone, with no one to perform for.\n\nThis drawing sits inside that decision, before the outcome, before anyone else knows what it cost — Christ in Gethsemane, Luke 22:41-44, the sweat like drops of blood left out of most paintings of this scene.',
    ...
    },
    {
      ...
      dimensions: '18 × 24 in',
      short_description: 'He had stood guard at a hundred executions and felt nothing about any of them.',
      story: 'He had stood guard at a hundred executions and felt nothing about any of them. A uniform teaches a person to hold their face a certain way.\n\nThis one he couldn’t look away from. And by the time it was over, the thing he said out loud surprised even him.\n\nThis is the centurion at the cross, in the second before the words come out — Mark 15:39.',
      categories: ['religious', 'military', 'human_emotion'],
      availability: 'available',
    ...
    },
    {
      ...
      medium: 'Graphite on paper',
      dimensions: '16 × 20 in',
      short_description: 'He had rehearsed the apology the whole way home. He never got to finish it.',
      story: 'He had rehearsed the apology the whole way home, certain it wouldn’t be enough.\n\nHe never got to finish it.\n\nThis is the moment the father reaches him first — while he was still a long way off — Luke 15:20.',
      categories: ['religious', 'human_emotion'],
  ...
  createStory({
    title: 'On Drawing the Moments Scripture Rushes Past',
    dek: 'Notes from the studio on why this work stays in graphite and charcoal, not color.',
    body: 'Color asks to be liked. Graphite and charcoal don’t have that problem — they can just sit with something difficult until it’s true.\n\nEvery piece here starts the same way: a passage I’ve read a hundred times, and paper. The Bible spends one verse on the moment a father starts running before his son finishes the apology. It spends half a sentence on a centurion changing his mind at the foot of a cross. I spend weeks there.',
    sort_order: 0,
  });
}
